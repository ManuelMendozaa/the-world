...
export default function BurundiFlag(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 512 512"
      fill="none"
    ...
    >
      <g clip-path="url(#clip0_181_403)">
        ...
        />
        <path
          d="M208.777 256L52.9021 100.124C-17.6239 191.776 -17.6239 320.224 52.9021 411.876L208.777 256Z"
          fill="#6DA544"
        />
        <path
          d="M303.224 256L459.098 411.876C529.624 320.224 529.624 191.776 459.098 100.124L303.224 256Z"
          fill="#6DA544"
        />
        <path
