...
export default function BelizeFlag(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 512 512"
      fill="none"
    ...
    >
      <g clip-path="url(#clip0_181_238)">
        <path
          d="M512 256C512 168.139 467.731 90.626 400.287 44.522L256 33.391L111.713 44.521C44.27 90.626 0 168.14 0 256C0 343.863 44.27 421.374 111.713 467.478L256 478.609L400.287 467.479C467.731 421.374 512 343.863 512 256Z"
          fill="#0052B4"
        />
        <path
        ...
        />
        <path
          d="M256 356.174C311.325 356.174 356.174 311.325 356.174 256C356.174 200.675 311.325 155.826 256 155.826C200.675 155.826 155.826 200.675 155.826 256C155.826 311.325 200.675 356.174 256 356.174Z"
          fill="#6DA544"
        />
        <path
