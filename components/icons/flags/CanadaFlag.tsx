...
export default function CanadaFlag(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 512 512"
      fill="none"
    ...
    >
      <g clip-path="url(#clip0_181_427)">
        ...
        />
        <path
          d="M512 256C512 154.506 452.935 66.8101 367.304 25.4021V486.597C452.935 445.19 512 357.494 512 256V256Z"
          fill="#D80027"
        />
        <path
