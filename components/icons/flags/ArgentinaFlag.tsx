...
export default function ArgentinaFlag(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 512 512"
      fill="none"
    ...
    >
      <g clip-path="url(#clip0_181_123)">
        ...
        />
        <path
          d="M256 0C154.506 0 66.8101 59.065 25.4021 144.696H486.597C445.19 59.065 357.493 0 256 0V0Z"
          fill="#338AF3"
        />
        <path
