...
export default function AustriaFlag(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 512 512"
      fill="none"
    ...
    >
      <g clip-path="url(#clip0_181_157)">
        ...
        />
        <path
          d="M256 512C366.07 512 459.906 442.528 496.076 345.043H15.922C52.094 442.528 145.928 512 256 512Z"
          fill="#D80027"
        />
        <path
          d="M256 0C145.928 0 52.094 69.472 15.922 166.957H496.077C459.906 69.472 366.07 0 256 0Z"
          fill="#D80027"
        />
      </g>
      <defs>
