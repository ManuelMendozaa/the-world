...
export default function GuatemalaFlag(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 512 512"
      fill="none"
      ...
      {...props}
    >
      <g clip-path="url(#clip0_181_889)">
        <path
          d="M256 512C397.385 512 512 397.385 512 256C512 114.615 397.385 0 256 0C114.615 0 0 114.615 0 256C0 397.385 114.615 512 256 512Z"
          fill="#F0F0F0"
        />
        <path
          d="M512 256C512 154.506 452.935 66.8099 367.304 25.4019V486.597C452.935 445.19 512 357.493 512 256V256Z"
          fill="#338AF3"
        />
        <path
          d="M0 256C0 357.493 59.065 445.19 144.696 486.598V25.4019C59.065 66.8099 0 154.506 0 256Z"
          fill="#338AF3"
        />
        <path
