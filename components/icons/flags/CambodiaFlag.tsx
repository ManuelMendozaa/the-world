...
export default function CambodiaFlag(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 512 512"
      fill="none"
    ...
    >
      <g clip-path="url(#clip0_181_416)">
        ...
        />
        <path
          d="M31.127 133.565H480.872C437.454 53.989 353.035 0 256 0C158.965 0 74.546 53.989 31.127 133.565V133.565Z"
          fill="#0052B4"
        />
        <path
