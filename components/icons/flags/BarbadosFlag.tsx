...
export default function BarbadosFlag(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 512 512"
      fill="none"
    ...
    >
      <g clip-path="url(#clip0_181_204)">
        ...
        />
        <path
          d="M144.696 25.411C59.066 66.817 0 154.506 0 256C0 357.494 59.066 445.183 144.696 486.589V25.411Z"
          fill="#0052B4"
        />
        <path
          d="M367.304 25.411V486.589C452.934 445.183 512 357.493 512 256C512 154.507 452.934 66.817 367.304 25.411Z"
          fill="#0052B4"
        />
        <path
