...
export default function BritishVirginIslandsFlag(
  ...
  return (
    ...
    >
      <g clip-path="url(#clip0_181_360)">
        ...
        />
        <path
          d="M256 224.519L165.045 133.566H133.565V133.568L255.998 256H256C256 256 256 234.293 256 224.519V224.519Z"
          fill="#D80027"
        />
        <path
