...
export default function ElSalvadorFlag(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 512 512"
      fill="none"
      ...
      {...props}
    >
      <g clip-path="url(#clip0_181_709)">
        <path
          d="M256 512C397.385 512 512 397.385 512 256C512 114.615 397.385 0 256 0C114.615 0 0 114.615 0 256C0 397.385 114.615 512 256 512Z"
          fill="#F0F0F0"
        />
        <path
          d="M256 0C154.506 0 66.81 59.065 25.402 144.696H486.597C445.19 59.065 357.493 0 256 0V0Z"
          fill="#0052B4"
        />
        <path
          d="M256 512C357.493 512 445.19 452.935 486.598 367.304H25.402C66.81 452.935 154.506 512 256 512Z"
          fill="#0052B4"
        />
        <path
