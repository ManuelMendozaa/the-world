...
export default function FijiFlag(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 512 512"
      fill="none"
    ...
    >
      <g clip-path="url(#clip0_181_774)">
        ...
        />
        <path
          d="M256 224.519L165.047 133.566H133.566V133.568L255.998 256H256C256 256 256 234.293 256 224.519Z"
          fill="#D80027"
        />
        <path
