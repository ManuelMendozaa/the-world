...
export default function BermudaFlag(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 512 512"
      fill="none"
    ...
    >
      <g clip-path="url(#clip0_181_252)">
        ...
        />
        <path
          d="M129.515 33.391C89.4761 56.19 56.1891 89.476 33.3911 129.515V267.13H100.174V100.176V100.174H267.13C267.13 79.111 267.13 59.045 267.13 33.391H129.515Z"
          fill="#D80027"
        />
        <path
          d="M266.177 234.694L165.045 133.565H133.565V133.567L266.174 266.176H266.176C266.177 266.177 266.177 244.47 266.177 234.694V234.694Z"
          fill="#D80027"
        />
        <path
