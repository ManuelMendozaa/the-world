...
export default function AfghanistanFlag(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 512 512"
      fill="none"
    ...
    >
      <g clipPath="url(#clip0_181_53)">
        ...
        />
        <path
          d="M256 222.609C243.705 222.609 233.739 232.575 233.739 244.87V278.261H278.261V244.87C278.261 232.575 268.295 222.609 256 222.609V222.609Z"
          fill="#FFDA44"
        />
      </g>
      <defs>
